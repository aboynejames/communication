...
ttHTML.prototype.commelementbuild = function(cci) {
	commelemhtml = '';
								...
								commelemhtml += '<div class="commlistitem" id="communicationelement' + cci +'" data-commid="' + cci +'"><div id="comel' + cci + '" ><div id="elementcounter">' + cci + '</div><div class="communicationpool"><div id="setauthored' + cci + '"></div></div></div><div class="communicationedit"><div class="sketchpadel"><a href="" id="sketchpad" data-sketchid="' + cci + '">sketchpad</a></div><div class="saveel"><a href="" id="save"  data-saveid="' + cci + '">---</a></div><div class="removeel"><a href="" id="remove" data-removeid ="' + cci + '">remove</a></div></div></div>';
